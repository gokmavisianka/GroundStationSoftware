...
# -------------------------------------------------------------------------------------------------------------------- #
    def setup_Tab1(self):
        ...
        self.add_GroupBox("variable_name", (177, 270, 200, 30), GroupBox="Graph", borderless=True)
        self.add_Label("variable_name", "Birim:", (0, 0, 100, 30), GroupBox="variable_name")
        self.add_LineEdit("variable_name", "", (100, 0, 100, 30), GroupBox="variable_name")
    ...
    def setup_Tab4(self):
        ...
        self.add_LineEdit("index", "", (480, 26, 100, 30), GroupBox="File")
...
# -------------------------------------------------------------------------------------------------------------------- #
    def setup_Templates(self):
        ...
        self.default_BarGraph = ["GraphType|Bar Grafiği", "graph_name|Mesafe Ölçer", "variable_name|cm", "x|150", "y|150", "width|100",
                                 "height|400", "frame_width|24", "minimum_value|0", "maximum_value|100", "scale_lines_count|10",
                                 "bar_color|kırmızı", "frame_color|mavi", "maximum_value_color|turkuaz", "average_value_color|sarı", "minimum_value_color|yeşil", "current_value_color|beyaz", "graph_name_color|kırmızı",
        ...
        self.BarGraphProperties = {"GraphType": "Bar Grafiği", "graph_name": None, "variable_name": None, "x": None, "y": None, "width": None,
...
class Bar:
    ...
    def setup_variables(self, args):
        self.graph_name, self.variable_name = args[1], args[2]
    ...
    def draw_scale_lines(self):
        ...
        for n in range(self.scale_lines_count + 1):
            text_value = round(self.maximum_value - n * value, 2)
            text = self.font.render(f"-{text_value}", True, (255, 255, 255))
    ...
    def show_values_as_text(self):
        ...
        text_var_current = self.font.render(f"{self.variable} {self.variable_name}", True, self.current_value_color)
        text_graph_name = self.font.render(self.graph_name, True, self.graph_name_color)
        VP.screen.blit(text_graph_name, (x, y + 75))
        VP.screen.blit(text_var_current, (x, y + 100))
